...
PLAYING_SECTIONS = [
    ...
    },
    {
        ...
        "content": ["This set of commands allows to to take the items that you might find in the world. Use a command word alongside the name of the item you want to pick up and you will add the item to your inventory."],
        "examples": ["Take sword"],
    },
    {
        ...
        "content": ["Some items within the world will be containers. These can be picked up and then opened with this command. The contents of the container will then be added to your inventory."],
        "examples": ["Open box"],
    },
    {
        ...
        "content": ["Currently the only items that have a 'use' function are keys. If you have a key in your inventory and use this command in the room that the key unlocks a door; the door will be unlocked."],
        "examples": ["Use key"],
    },
    {
        ...
        "content": ["Items you hold or are in the current room can be described. This might reveal extra information that is not contained within the description of the room with the item in it."],
